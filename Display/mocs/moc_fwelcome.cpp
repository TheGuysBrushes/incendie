...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Fwelcome_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 58, 13)
    ...
    "popImageDIalog\0popSaveDialog\0popSeedDialog\0"
};
...
const QMetaObject Fwelcome::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Fwelcome.data,
      qt_meta_data_Fwelcome,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Fwelcome.stringdata))
