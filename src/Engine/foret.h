...
public:
    ...
    size_t nbEssences(){ return essences.size() ; }
    ...
    /**
     * Lit les essences d'une foret depuis un flux
     * @author Florian
     * @param file fichier de sauvegarde de foret, tête de lecture placée au début des essences
     */
